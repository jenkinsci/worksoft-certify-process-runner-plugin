...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","F:\\Plugins\\worksoft-certify-process-runner-plugin");
    parameters.put("artifactId","worksoft-certify-process-runner");
    parameters.put("outputDirectory","F:\\Plugins\\worksoft-certify-process-runner-plugin\\target\\classes");
    parameters.put("testOutputDirectory","F:\\Plugins\\worksoft-certify-process-runner-plugin\\target\\test-classes");
